...
func TestUpdateAccountRoleByID(t *testing.T) {
	// init mock
	...
	accountModel := &iomodel.AccountChangeRole{}
	accountModel.Role = gofakeit.Number(1, 4)

	Convey("Test Update Role By ID", t, func() {
		Convey("Update Account By ID Fail", func() {
			...
			err := uc.UpdateAccountRoleByID(ctx, accountModel, id)
