...
func (uc *bookingUseCase) GetBookingByPlaceID(ctx context.Context, placeId int) (*iomodel.GetBookingResp, error) {
	booking, err := uc.bookingSto.GetByPlaceID(ctx, placeId)
	if err != nil {
		return nil, err
	}
